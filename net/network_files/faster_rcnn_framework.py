...
class FasterRCNN(FasterRCNNBase):
    ...
    def __init__(self, backbone, num_classes=None,
                 ...
                 rpn_nms_thresh=0.4,  # rpn中进行nms处理时使用的iou阈值
                 ...
                 # 这里的box_num_thresh从0.5修改为0.4,主要是重复检测去不掉啊啊啊啊
        ...
        if rpn_anchor_generator is None:
            ...
            anchor_sizes = ((33,), (72,), (156,), (168,), (325,))
            #中间值  41  100  248  278  425   0.754
            #最大值  66  144  314  335   650  0.756
            print(anchor_sizes)
            # anchor_sizes = ((33,), (72,), (156,), (168,), (325,))  # reach 0.760647
            # anchor_sizes = ((36,), (68,), (140,), (190,), (300,))  # reach  76.1
            # anchor_sizes = ((34,), (68,), (155,), (195,), (357,))  # reach 75.7  垃圾
        ...
        if rpn_head is None:
            rpn_head = RPNHead(
                out_channels, rpn_anchor_generator.num_anchors_per_location()[0]  # 每个位置的anchor数量，也就是15
            )
