...
from use_for_me_model_se_stn_nonl import get_detection_local_model1, get_detection_model
...
def main(parser_data):
    ...
    if args.aspect_ratio_group_factor >= 0:
        train_sampler = torch.utils.data.RandomSampler(train_dataset)  # 无放回的随机采样样本元素
    ...
    # model = get_detection_model(21, 0)
    model = get_detection_local_model1(21, 0, 0, choose='frozenBN')
    # model = get_detection_local_model3(21)
    # print(model)
