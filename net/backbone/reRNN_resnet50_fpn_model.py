...
from .reRNN_feature_pyramid_network  import FeaturePyramidNetwork, FakeFPN11, LastLevelMaxPool
...
class BackboneWithFPN(nn.Module):
    ...
    def __init__(self, backbone, return_layers, in_channels_list, out_channels, extra_blocks=None, use_eca=0):
        ...
        self.fpn = FeaturePyramidNetwork(  # 而fpn的构建只需要左边的通道数量和自己需要输出的通道即可，确实
            in_channels_list=in_channels_list,
            out_channels=out_channels,
...
def resnet50_refpn_backbone(pretrain_path="",
    ...
    out_channels = 256
    return BackboneWithFPN(resnet_backbone, return_layers, in_channels_list, out_channels, extra_blocks=extra_blocks, use_eca=use_eca)
